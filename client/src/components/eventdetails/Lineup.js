                ...
                <div className="lineup container">
                    <div className="white-box mt-2">
                        <div className="formation">
                            <div className="row">
                                <div
                                    className={'col home' + (this.state.defaultFormation === 1 ? ' active' : '')}
                                ...
                                >
                                    ...
                                    {homeFormation.map((item, index) => {
                                        return (
                                            <span key={index}>
                                                {item}
                                                {index === homeFormation.length - 1 ? '' : ' - '}
                                            </span>
                                        );
                                    })}
                                </div>
                                <div
                                    className={'col away' + (this.state.defaultFormation === 2 ? ' active' : '')}
                                                ...
                                                <div className="picture">
                                                    ...
                                                    {activeTeam.lineupsSorted[0].rating ? (
                                                        <span
                                                            className={
                                                                'text-bold rating ' +
                                                                ratingClass(activeTeam.lineupsSorted[0].rating)
                                                            }
                                                        >
                                                            {activeTeam.lineupsSorted[0].rating}
                                                        </span>
                                ...
                                <div className="row align-items-center">
                                    <div className="col col-coach-picture">
                                        <img
                                            ...
                                            src={
                                                window.ImageServer + '/images/manager/' + activeTeam.manager.id + '.png'
                                            }
                                        />
                                    </div>
                                    <div className="col">
                        ...
                        <div className="body list">
                            <ul className="horizontal-tab">
                                <li
                                    className={this.state.listTab === 0 ? 'active' : ''}
                                    onClick={() => this.listTabHandler(0)}
                                >
                                    <span>
                                        <Trans>Lineup</Trans>
                                    </span>
                                ...
                                <li
                                    className={this.state.listTab === 1 ? 'active' : ''}
                                    onClick={() => this.listTabHandler(1)}
                                >
                                    <span>
                                        ...
                                        <div className="col list-text">
                                            <div className="f-700">
                                                ...
                                                {item.substitute && item.rating !== '–' ? (
                                                    <span key={index} className={'mx-1 lineup-icon substitutionin'} />
                                                ) : (
                                                    ''
                                                )}
                                            </div>
