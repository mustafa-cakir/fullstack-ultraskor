        ...
        return (
            <div className="forum container">
                <div className="white-box mt-2">
                    ...
                    <div
                        className={'modal fade' + (showuserNameModal ? ' show' : '')}
                        tabIndex="-1"
                        ...
                        <div className="modal-dialog modal-dialog-centered" role="document">
                            <div className="modal-content">
                                ...
                                <div className="modal-body">
                                    <p>
                                        <Trans>
                                            Please enter your name or a nickname to label your messages in the forum
                                        </Trans>
                                    </p>
                                    <input
                                        type="text"
                        ...
                        <form className="row" onSubmit={this.messageSubmit.bind(this)}>
                            ...
                            >
                                <div className="userName">
                                    {userName ? userName.substring(0, 1) : <Icon name="fas fa-question" />}
                                </div>
                            </div>
                            ...
                            <div className="col col-submit">
                                <button type="submit" className={textAreaFilled ? 'filled' : ''}>
                                    <Icon name="fa fa-paper-plane" />
                                </button>
                            </div>
                        </form>
                    </div>
                        ...
                        {messages.length > 0 ? (
                            <ul>
                                {messages.map((message, index) => (
                                    <li key={index}>
                                        <div
                                            className={'li-container' + (message.userName === userName ? ' mine' : '')}
                                        >
                                            ...
                                            <time>
                                                {moment(message.date).isSame(moment(), 'day')
                                                    ...
                                                    : moment(message.date).format('DD MMM, HH:mm')}
                                            </time>
                                        </div>
                                    </li>
                                ))}
                            ...
                            <React.Fragment>
                                <div className="bubble">
                                    <span>
                                        <Trans>No message has yet been posted</Trans>
                                    </span>
                                </div>
                                <div className="bubble">
                                    <span>
                                        <Trans>Be the first one</Trans> ;)
                                    </span>
                                </div>
                            </React.Fragment>
                        )}
