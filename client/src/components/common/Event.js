    ...
    isInProgress() {
        ...
        switch (this.props.event.status.type) {
            ...
            case "notstarted":
                text =
                    <div className="full-time font-weight-bold">
	                    <div className="day">
		                    {moment(this.props.event.startTimestamp * 1000).isSame(moment(), 'day') ? <Trans>Today</Trans> :
            ...
            case "postponed":
                ...
                break;
            default:
                text = from === "h2h" || from === "fixture" ? <div className="full-time in-the-past">{moment(this.props.event.startTimestamp * 1000).format('DD.MM.YY')}</div> : <div className="full-time font-weight-bold"><Trans>FT</Trans></div>
        }
        return text;
    }
                ...
                <div className="container">
                    <div className="row">
                        ...
                        <Link to={{
                            ...
                            state: {isPrev: true},
                        }} className="event-link col p-0" title={`${event.homeTeam.name} - ${event.awayTeam.name}  ${t('click for live scores, lineup and stats')}`}>
	                    ...
	                    {(from === "h2h" || from === "fixture") ? (
		                    <div className="col event-fav half-time-score pl-0 text-right pr-2" onClick={this.favClickHandler.bind(this)}>
