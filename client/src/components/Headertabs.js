        ...
        return (
            <ul className="header-tabs row">
                <li className="col p-0">
                    <div className="header-tabs-container" onClick={this.openSportDropdown.bind(this)} tabIndex="0">
                        <Icon name="far fa-futbol mr-2" />
                        Futbol
                        <Icon name={'ml-2 fas fa-angle-' + (this.state.isSportDropdown ? 'up' : 'down')} />
                    </div>
                    <div
                        className={'dropdown-menu sports left' + (this.state.isSportDropdown ? ' show' : '')}
                    ...
                    >
                        {moment(this.state.selectedDay).format('YYYY-MM-DD') === moment().format('YYYY-MM-DD') ? (
                            ...
                            <div className={'selected-date'}>
                                <span>{moment(this.state.selectedDay).format('DD')}</span>
                                <span>{moment(this.state.selectedDay).format('MMM')}</span>
                            </div>
                        )}
                ...
                <li className={'col col-filter p-0' + (this.props.filteredTournaments.length > 0 ? ' active' : '')}>
                    ...
                    <div
                        className={'dropdown-menu filters right' + (this.state.isFilterDropdown ? ' show' : '')}
                        aria-labelledby="dropdownMenuButton"
                    >
            ...
            <div key={index}>
                ...
                >
                    ...
                    <div className="col tournament-name px-2">
                        ...
                        - <Trans>{tournament.tournament.name}</Trans>
                    </div>
                </div>
                <hr className="separator" />
            </div>
