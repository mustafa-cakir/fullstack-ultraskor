                                        ...
                                        {iddaaFullMarketData ? (
                                            <div className="iddaa-body">
                                                <div className="row align-items-center row-dropdown">
                                                    <div className="col p-0 col-6 col-md-3">
                                                        {iddaaFullMarketData.m && iddaaFullMarketData.m.length > 0 && (
                                                            ...
                                                            >
                                                                <Trans>{selectedGroup.name}</Trans> (
                                                                {this.getCountByGroup(selectedGroup)})
                                                ...
                                                <IddaaContainer
                                                    ...
                                                    iddaaFullMarketData={iddaaFullMarketData}
                                                    t={t}
                                                />
                                            </div>
                                        ) : (
...
const PrintErrorOrGetFromParent = ({ iddaaMatchData }) => {
    ...
    return (
        <div className="iddaa-notfound">
            <Trans>Unfortunately, this event doesn't have Iddaa bettings odds</Trans> :(
        </div>
    );
};
...
class MatchTextInfo extends PureComponent {
    ...
    render() {
        ...
        if (!matchTextInfo || matchTextInfo.length === 0) {
            return (
                <div className="iddaa-notfound">
                    <Trans>Unfortunately, this event doesn't have any Iddaa Analyze</Trans> :(
                </div>
            );
        }
